...
const TestimonialsColoumn = (props: { className?: string; duration?: number; testimonials: typeof testimonials }) => {
  return (
    ...
    <section className="bg-white">
      <div className="container">
        ...
        <div className="flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px] overflow-hidden">
          <TestimonialsColoumn testimonials={firstColoumn} duration={15} />
          <TestimonialsColoumn testimonials={secondColoumn} className="hidden md:block" duration={19} />
          <TestimonialsColoumn testimonials={thirdColoumn} className="hidden lg:block" duration={17} />
        </div>
      </div>
    </section>
  );
